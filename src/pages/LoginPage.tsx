...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gray-50 p-4">
      <div className="pointer-events-none absolute -left-10 top-10 size-40 rounded-2xl bg-mint-300/60" aria-hidden />
      <div className="pointer-events-none absolute right-16 top-24 size-24 rounded-2xl border-2 border-gold-400" aria-hidden />
      <div className="pointer-events-none absolute -right-6 bottom-32 size-28 rounded-2xl bg-gold-400/70" aria-hidden />
      <div className="pointer-events-none absolute bottom-0 left-0 h-24 w-full bg-primary-600/95" aria-hidden />
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-xl">
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          Tem um convite?{' '}
          <Link to={ROUTES.signup} className="font-medium text-primary-700 hover:underline">
            Criar conta
          </Link>
        </p>
      </div>
